...
export const stats = [["03", "Selected projects"], ["01+", "Years learning"], ["2", "Tools explored"], ["∞", "Curiosity level"]];
...
export const experience = [
  { year: "June 2025", role: "Starting My Journey in Software Engineering", company: "Discovering the World of Software Development", description: "I began my journey into coding in 2025 after being accepted into SMKN 1 Pasuruan, where I chose to major in Software Engineering. This marked the beginning of my journey into technology and software development.", tools: ["HTML", "CSS", "Python"] },
  { year: "September 2025", role: "Exploring the Software Industry", company: "Expanding My Coding Skills with UBIG", description: "I continued developing my coding skills through hands-on learning and direct guidance from PT. Universal BIG Data (UBIG). This experience gave me valuable insights into the software industry and strengthened my foundation in programming.", tools: ["ShadCN UI", "Tailwind CSS", "Supabase"] },
  { year: "March 2026", role: "Building My First Website with Next.js", company: "Exploring Modern Web Development", description: "I developed a responsive website using Next.js and successfully deployed it with Vercel. Through this project, I strengthened my understanding of modern web development and gained practical experience in building and deploying web applications.", tools: ["Figma", "Next.js", "React"] },
];
...
export const projects = [
  ...
  { slug: "lifechoice", number: "02", title: "LifeChoice", category: "Life management", description: "A simple dashboard for turning daily intentions into decisions you can actually act on.", image: "/images/projects/LifeChoice.png", technologies: ["React", "Node.js", "Supabase"], githubUrl: "https://github.com/", liveUrl: "https://example.com", featured: false, color: "peach" },
...
export const achievements = [
  { title: "Passed the industry class selection process", year: "2025", level: "2", description: "During my first year as a software engineering student, I successfully passed the selection process to join the UBIG industry class." },
  
];

// Sertifikat yang dapat dibuka untuk melihat gambar dalam modal preview.
export const certificates = [
  { title: "Understanding AI", issuer: "Senopaty academy - Polri - Kemendikdasmen", year: "2026", image: "/images/projects/sertifikat-1.jpg", link: "https://www.freecodecamp.org/" },
];

// Riwayat pendidikan formal pemilik portfolio.
export const education = [{ year: "2025 — Now", school: "SMKN 1 Pasuruan", major: "Software Engineering", description: "A hands-on education in web development, databases, product thinking, and collaborative delivery." }];
